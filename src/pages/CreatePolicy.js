            ...
            <form onSubmit={handleSubmit}>
                <div className="row">
                    <div className="col-md-6">
                        ...
                        />
                        {errors.policy_effective_date && (
                            <div className="invalid-feedback">
                                {errors.policy_effective_date[0]}
                            </div>
                        )}
                    </div>
                    ...
                    <div className="col-md-6">
                        ...
                        {errors.policy_expiration_date && (
                            <div className="invalid-feedback">
                                {errors.policy_expiration_date[0]}
                            </div>
                        )}
                    </div>
                </div>
                ...
                <h4>Policy Holder</h4>
                <div className="row">
                    {Object.entries(formData.policy_holder).map(([key, val]) => (
                            ...
                            {['year', 'make', 'model', 'vin', 'usage', 'primary_use', 'annual_mileage', 'ownership'].map(field => (
                                <div className="col-md-6 mb-2" key={field}>
                                    ...
                                    {errors[`vehicles.${vIndex}.${field}`] && (
                                        <div className="invalid-feedback">
                                            {errors[`vehicles.${vIndex}.${field}`][0]}
                                        </div>
                                    )}
                                </div>
                            ))}
                            ...
                            {Object.entries(vehicle.garaging_address).map(([key, val]) => (
                                <div className="col-md-6 mb-2" key={key}>
                                    ...
                                    {errors[`vehicles.${vIndex}.garaging_address.${key}`] && (
                                        <div className="invalid-feedback">
                                            {errors[`vehicles.${vIndex}.garaging_address.${key}`][0]}
                                        </div>
                                    )}
                                </div>
                            ))}
                ...
                <div className="d-flex justify-content-between">
                    <button className="btn btn-outline-secondary" type="button" onClick={() => window.history.back()}>Cancel</button>
